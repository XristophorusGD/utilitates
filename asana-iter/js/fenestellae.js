...
class fenestellaItinerariumVacuefaciendiGII
{
	static #simulacrum;
	static #fenestella;
	static #seConstituit = false;
	static #pagina = path.join(__dirname, "..","/html/itinerariumVacuefacereGII.html");
//	static #pagina = path.join("/static/htmladderePensumAsana.html");
	static #mensurae = [250,150]

	constructor()
	{
		if (!fenestellaItinerariumVacuefaciendiGII.#seConstituit)
		{
			throw new TypeError("functione new simulacrum non creatur")
		}
		else
		{
			console.log("Fenestella qua index itinerariorum vere vacuefit creata")
		}
	}
	static #estneFenestella()
	{
	...
	async #initialize(eCongeries)
	{
		try
		{
			fenestellaItinerariumVacuefaciendiGII.#fenestella = new BrowserWindow(
				{

					alwaysOnTop: false,
					frame: false,
					resizable: false,
			                width:  fenestellaItinerariumVacuefaciendiGII.#mensurae[0],
			                height: fenestellaItinerariumVacuefaciendiGII.#mensurae[1],
			                webPreferences:
					{
						nodeIntegration: false,
						contextIsolation: true,
				...
				fenestellaItinerariumVacuefaciendiGII.#fenestella.loadFile(fenestellaItinerariumVacuefaciendiGII.#pagina)
		}
		catch(error)
		{
			console.log(error)
	...
	static utiFenestella(eCongeries)
	{
		return new Promise(async (solutum, falsum) =>
		{
			if(!fenestellaItinerariumVacuefaciendiGII.#estneFenestella())
			{
				fenestellaItinerariumVacuefaciendiGII.#seConstituit = true;
				fenestellaItinerariumVacuefaciendiGII.#simulacrum = new fenestellaItinerariumVacuefaciendiGII();
				await fenestellaItinerariumVacuefaciendiGII.#simulacrum.#initialize(eCongeries)
			}
			solutum(fenestellaItinerariumVacuefaciendiGII.#fenestella)
		})
	}

	static relinquereFenestellam()
	{
		fenestellaItinerariumVacuefaciendiGII.#fenestella.close();
		fenestellaItinerariumVacuefaciendiGII.#simulacrum = undefined;
		fenestellaItinerariumVacuefaciendiGII.#fenestella = undefined;
		fenestellaItinerariumVacuefaciendiGII.#seConstituit = false;
	}
}
/*
 *
 ...
 * Descriptio: Constituit novam fenestellam quâ probâtur ûsuârius itiner¿rium vacuefacere
 * Intus:  nullus
 * Exitus: nullus
 */
	...
	static utiFenestella(eCongeries)
	{
		return new Promise(async (solutum, falsum) =>
		{
			if(!fenestellaItinerariumVacuefaciendiGI.#estneFenestella())
			{
				...
				fenestellaItinerariumVacuefaciendiGI.#simulacrum = new fenestellaItinerariumVacuefaciendiGI;
				await fenestellaItinerariumVacuefaciendiGI.#simulacrum.#initialize(eCongeries)
			}
			solutum(fenestellaItinerariumVacuefaciendiGI.#fenestella)
		})
	}
